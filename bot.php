      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/NNPPU1/15",
                   'caption'=>'𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗖𝗢𝗡𝗧𝗥𝗢𝗟 ✅
𝘾𝙤𝙣𝙩𝙖𝙘𝙩 𝘿𝙚𝙫𝙚𝙡𝙤𝙥𝙚𝙧 - @FFPPPPP',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'➕ اضافه حسابات وهميه ➕','callback_data'=>'login'],['text'=>'➖صفحه التحكم ➖','callback_data'=>'backakil']],
                       [['text'=>"قناتي ✔ ", 'url'=>"https://t.me/ABDTOOLS"],['text'=>"المطور ➿ ", 'url'=>"https://t.me/ABDTOOLS"]],
          	...
          	if($config['mode'] != null){
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>' قناتي❗','url'=>'t.me/ABDTOOLS'],['text'=>'المطور❔','url'=>'t.me/FFPPPPP']],
                      ]
                  ])
                  ]);
          		    $config['mode'] = null;
...
اضغط في الاسفل لمراسله المطور 👇",
                								...
                								'reply_markup'=>json_encode([
                								          ...
                								          'inline_keyboard'=>[
                								                   ...
                								                   [['text'=>'اضغط لمراسله المطور 🗣','url'=>'t.me/FFPPPPP']],
     ...
     $bot->sendMessage([
                      ...
                      'text'=>"التحكم بلبوت @ABDTOOLS ",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'قناتي','url'=>'t.me/ABDTOOLS'],['text'=>'تواصل','url'=>'t.me/FFPPPPP']],
                           [['text'=>'اشتراك بلبوت','url'=>'t.me/FFPPPPP']],
